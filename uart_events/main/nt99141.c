...
#include "include/nt99141_regs.h"
#include "include/nt99141_settings.h"
...
//aiden_test 0302 camera
    ...
    ret = write_reg(sensor->slv_addr, COMPRESSION_CTRL07, qs & 0xff);
#else
...
//aiden_test 0302 camera
#if defined(FEATURE_mPERS_CAM_Debug)    
    ret = write_reg(sensor->slv_addr, 0x32FC, 0x00);
#endif
...
//aiden_test 0302 camera
#if defined(FEATURE_mPERS_CAM_Debug)
    sensor->status.quality = read_reg(sensor->slv_addr, COMPRESSION_CTRL07) & 0xff;
#else
